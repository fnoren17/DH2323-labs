...
//    g_pParticleSystems[1]->SetTexture( "..\\particle.bmp" );
	...
	g_pParticleSystems[6]->SetMaxParticles(8400);
	g_pParticleSystems[6]->SetNumToRelease(10);
	g_pParticleSystems[6]->SetReleaseInterval(0.001f);
	...
	g_pParticleSystems[6]->SetWind(MyVector(1.0f, 0.0f, 0.0f));
	g_pParticleSystems[6]->SetAirResistence(true);

	g_pParticleSystems[6]->SetVelocityVar(2.0f);

	g_pParticleSystems[6]->SetCollisionPlane(MyVector(-1.0f, 0.0f, 0.0f), MyVector(3.0f, 0.0f, 0.0f)); // Right Wall
